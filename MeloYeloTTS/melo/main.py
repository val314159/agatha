...
@click.option("--nondeterminism", '-n', is_flag=True, show_default=True, default=False, help="deternimism")
...
def main(text, file, output_path, language, speaker, speed, device, nondeterminism):
    if nondeterminism:
        seed = 0
